<template>
   <div class="custom-select" >
      ...
      <div class="dropdown" :class="{selectHide : !open}" >
         <input type="text" tabindex="0" class="search" v-model="search" placeholder="search..." />
   ...
   computed: {
      filteredCurrencies: function()
      {
         ...
         return this.currencies.filter((currency) => {
            return (
               currency.search.indexOf(self.search.toUpperCase()) >= 0
            )
         });
      }
   },
...
.custom-select .items div:hover, .custom-select .items div:focus {
